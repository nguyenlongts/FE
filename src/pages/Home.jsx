...
//     try {
//       // Gọi API kiểm tra phòng
//       const response = await fetch(
//         `http://localhost:5110/api/Meeting/check/${roomCode}`
//       );
//       const result = await response.json();

//       if (result.data) {
//         // Nếu phòng tồn tại, redirect
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="space-y-5">
                ...
                <button
                  onClick={handleJoinMeeting}
                  disabled={isLoading}
                  className="w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-700 hover:to-purple-700 transition font-semibold text-lg shadow-lg flex items-center justify-center space-x-2 group disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <span>
